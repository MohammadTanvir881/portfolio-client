...
import { updateBlogIntoDb } from "@/actions/Blogs/UpdateBlogsData";
...
const UpdateBlogForm = ({ blogdata }: { blogdata: TBlog }) => {
  // console.log("From Update Form" , blogdata )
  const { _id, content, image, title, category } = blogdata;
  const {
    register,
    handleSubmit,
    formState: { errors },
